...
const FREQ_LABEL: Record<string, string> = {
  ...
  "quotidien": "Quotidien",
  "1_fois_mois": "1×/semaine", "2_fois_mois": "2×/mois", "3_fois_mois": "3×/mois", "4_fois_mois": "4×/mois",
  "bi-hebdomadaire": "Bi-hebdo", "hebdomadaire": "Hebdo", "mensuel": "1×/semaine", "abonnement": "Abonnement",
};
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <TabsContent value="planning" className="m-0 space-y-4">
          <PlanningMoisPanel getEntries={getPlanningEntries} services={servicesOptions} villes={villesOptions} commerciaux={commerciaux Options} />
        </TabsContent>
